...
imagen = cv2.imread('formulario_04.png', cv2.IMREAD_GRAYSCALE)
umbral = 110
...
h, w = imagen_binarizada.shape
#print(h,w)
#el umbral esta diseñado para que se adapte a otras imagenes
umbral_filas = h*0.15
umbral_columnas = w*0.15
